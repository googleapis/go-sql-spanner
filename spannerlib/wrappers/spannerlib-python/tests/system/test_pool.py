...
from google.cloud.spannerlib import Connection, Pool  # noqa: E402
from google.cloud.spannerlib import SpannerLibError  # noqa: E402
...
class TestPoolE2E(unittest.TestCase):
    ...
    def test_create_connection_success(self):
        """Test creating a connection from an open pool."""
        with Pool.create_pool(get_test_connection_string()) as pool:
    ...
    def test_create_connection_context_manager(self):
        """Test creating a connection using a context manager."""
        with Pool.create_pool(get_test_connection_string()) as pool:
    ...
    def test_create_connection_from_closed_pool(self):
        """Test creating a connection from a closed pool raises an error."""
        pool = Pool.create_pool(get_test_connection_string())
        pool.close()
