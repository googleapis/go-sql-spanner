...
TEST_CONNECTION_STRING = "projects/test-project/instances/test-instance/databases/test-database"
...
class TestSpannerLib(unittest.TestCase):
    ...
    def test_pool_creation_and_close(self, mock_pool_lib):
        mock_pool_lib.CreatePool.return_value = _GoReturn(r0=1, r1=0, r2=1, r3=0, r4=None)
        mock_pool_lib.ClosePool.return_value = _GoReturn(r0=0, r1=0, r2=0, r3=0, r4=None)
    ...
    def test_connection_creation_and_close(self, mock_pool_lib, mock_conn_lib):
        mock_pool_lib.CreatePool.return_value = _GoReturn(r0=1, r1=0, r2=1, r3=0, r4=None)
        mock_pool_lib.CreateConnection.return_value = _GoReturn(r0=101, r1=0, r2=101, r3=0, r4=None)
        mock_conn_lib.CloseConnection.return_value = _GoReturn(r0=0, r1=0, r2=0, r3=0, r4=None)
        mock_pool_lib.ClosePool.return_value = _GoReturn(r0=0, r1=0, r2=0, r3=0, r4=None)
