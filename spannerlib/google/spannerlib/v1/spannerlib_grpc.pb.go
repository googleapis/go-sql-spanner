...
const (
	...
	SpannerLib_ExecuteTransaction_FullMethodName = "/google.spannerlib.v1.SpannerLib/ExecuteTransaction"
	SpannerLib_ExecuteBatchDml_FullMethodName    = "/google.spannerlib.v1.SpannerLib/ExecuteBatchDml"
	...
	SpannerLib_Apply_FullMethodName              = "/google.spannerlib.v1.SpannerLib/Apply"
	SpannerLib_BufferWrite_FullMethodName        = "/google.spannerlib.v1.SpannerLib/BufferWrite"
...
type SpannerLibClient interface {
	...
	ExecuteStreaming(ctx context.Context, in *ExecuteRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[spannerpb.PartialResultSet], error)
	ExecuteTransaction(ctx context.Context, in *ExecuteTransactionRequest, opts ...grpc.CallOption) (*Rows, error)
	ExecuteBatchDml(ctx context.Context, in *ExecuteBatchDmlRequest, opts ...grpc.CallOption) (*spannerpb.ExecuteBatchDmlResponse, error)
	Metadata(ctx context.Context, in *Rows, opts ...grpc.CallOption) (*spannerpb.ResultSetMetadata, error)
	Next(ctx context.Context, in *Rows, opts ...grpc.CallOption) (*structpb.ListValue, error)
	...
	Commit(ctx context.Context, in *Transaction, opts ...grpc.CallOption) (*spannerpb.CommitResponse, error)
	Rollback(ctx context.Context, in *Transaction, opts ...grpc.CallOption) (*emptypb.Empty, error)
	Apply(ctx context.Context, in *ApplyRequest, opts ...grpc.CallOption) (*spannerpb.CommitResponse, error)
	BufferWrite(ctx context.Context, in *BufferWriteRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *spannerLibClient) ExecuteStreaming(ctx context.Context, in *ExecuteRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[spannerpb.PartialResultSet], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &SpannerLib_ServiceDesc.Streams[0], SpannerLib_ExecuteStreaming_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[ExecuteRequest, spannerpb.PartialResultSet]{ClientStream: stream}
...
type SpannerLib_ExecuteStreamingClient = grpc.ServerStreamingClient[spannerpb.PartialResultSet]

func (c *spannerLibClient) ExecuteTransaction(ctx context.Context, in *ExecuteTransactionRequest, opts ...grpc.CallOption) (*Rows, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Rows)
	err := c.cc.Invoke(ctx, SpannerLib_ExecuteTransaction_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *spannerLibClient) ExecuteBatchDml(ctx context.Context, in *ExecuteBatchDmlRequest, opts ...grpc.CallOption) (*spannerpb.ExecuteBatchDmlResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(spannerpb.ExecuteBatchDmlResponse)
	err := c.cc.Invoke(ctx, SpannerLib_ExecuteBatchDml_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *spannerLibClient) Next(ctx context.Context, in *Rows, opts ...grpc.CallOption) (*structpb.ListValue, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *spannerLibClient) BeginTransaction(ctx context.Context, in *BeginTransactionRequest, opts ...grpc.CallOption) (*Transaction, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Transaction)
...
func (c *spannerLibClient) Commit(ctx context.Context, in *Transaction, opts ...grpc.CallOption) (*spannerpb.CommitResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *spannerLibClient) Rollback(ctx context.Context, in *Transaction, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
func (c *spannerLibClient) Apply(ctx context.Context, in *ApplyRequest, opts ...grpc.CallOption) (*spannerpb.CommitResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(spannerpb.CommitResponse)
	err := c.cc.Invoke(ctx, SpannerLib_Apply_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *spannerLibClient) BufferWrite(ctx context.Context, in *BufferWriteRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, SpannerLib_BufferWrite_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SpannerLibServer interface {
	...
	ExecuteStreaming(*ExecuteRequest, grpc.ServerStreamingServer[spannerpb.PartialResultSet]) error
	ExecuteTransaction(context.Context, *ExecuteTransactionRequest) (*Rows, error)
	ExecuteBatchDml(context.Context, *ExecuteBatchDmlRequest) (*spannerpb.ExecuteBatchDmlResponse, error)
	Metadata(context.Context, *Rows) (*spannerpb.ResultSetMetadata, error)
	Next(context.Context, *Rows) (*structpb.ListValue, error)
	...
	Commit(context.Context, *Transaction) (*spannerpb.CommitResponse, error)
	Rollback(context.Context, *Transaction) (*emptypb.Empty, error)
	Apply(context.Context, *ApplyRequest) (*spannerpb.CommitResponse, error)
	BufferWrite(context.Context, *BufferWriteRequest) (*emptypb.Empty, error)
...
func (UnimplementedSpannerLibServer) ExecuteStreaming(*ExecuteRequest, grpc.ServerStreamingServer[spannerpb.PartialResultSet]) error {
	return status.Errorf(codes.Unimplemented, "method ExecuteStreaming not implemented")
}
func (UnimplementedSpannerLibServer) ExecuteTransaction(context.Context, *ExecuteTransactionRequest) (*Rows, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ExecuteTransaction not implemented")
}
func (UnimplementedSpannerLibServer) ExecuteBatchDml(context.Context, *ExecuteBatchDmlRequest) (*spannerpb.ExecuteBatchDmlResponse, error) {
...
func (UnimplementedSpannerLibServer) Next(context.Context, *Rows) (*structpb.ListValue, error) {
...
func (UnimplementedSpannerLibServer) BeginTransaction(context.Context, *BeginTransactionRequest) (*Transaction, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BeginTransaction not implemented")
}
func (UnimplementedSpannerLibServer) Commit(context.Context, *Transaction) (*spannerpb.CommitResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Commit not implemented")
}
func (UnimplementedSpannerLibServer) Rollback(context.Context, *Transaction) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Rollback not implemented")
}
func (UnimplementedSpannerLibServer) Apply(context.Context, *ApplyRequest) (*spannerpb.CommitResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Apply not implemented")
}
func (UnimplementedSpannerLibServer) BufferWrite(context.Context, *BufferWriteRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BufferWrite not implemented")
}
...
func _SpannerLib_ExecuteStreaming_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(SpannerLibServer).ExecuteStreaming(m, &grpc.GenericServerStream[ExecuteRequest, spannerpb.PartialResultSet]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type SpannerLib_ExecuteStreamingServer = grpc.ServerStreamingServer[spannerpb.PartialResultSet]

func _SpannerLib_ExecuteTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ExecuteTransactionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SpannerLibServer).ExecuteTransaction(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SpannerLib_ExecuteTransaction_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SpannerLibServer).ExecuteTransaction(ctx, req.(*ExecuteTransactionRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _SpannerLib_ExecuteBatchDml_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ExecuteBatchDmlRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SpannerLibServer).ExecuteBatchDml(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SpannerLib_ExecuteBatchDml_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SpannerLibServer).ExecuteBatchDml(ctx, req.(*ExecuteBatchDmlRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _SpannerLib_Next_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SpannerLibServer).Next(ctx, req.(*Rows))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _SpannerLib_Commit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SpannerLibServer).Commit(ctx, req.(*Transaction))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _SpannerLib_Rollback_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SpannerLibServer).Rollback(ctx, req.(*Transaction))
	}
	return interceptor(ctx, in, info, handler)
}

func _SpannerLib_Apply_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ApplyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SpannerLibServer).Apply(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SpannerLib_Apply_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SpannerLibServer).Apply(ctx, req.(*ApplyRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _SpannerLib_BufferWrite_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BufferWriteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SpannerLibServer).BufferWrite(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SpannerLib_BufferWrite_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SpannerLibServer).BufferWrite(ctx, req.(*BufferWriteRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SpannerLib_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _SpannerLib_ExecuteTransaction_Handler,
		},
		{
			MethodName: "ExecuteBatchDml",
			Handler:    _SpannerLib_ExecuteBatchDml_Handler,
		},
		{
			MethodName: "Metadata",
		...
		{
			MethodName: "Apply",
			Handler:    _SpannerLib_Apply_Handler,
		},
		{
			MethodName: "BufferWrite",
			Handler:    _SpannerLib_BufferWrite_Handler,
		},
	},
