...
func TestNoLeak(t *testing.T) {
	...
	goleak.VerifyNone(t, ignoreCurrent,
		goleak.IgnoreTopFunction("cloud.google.com/go/spanner.(*sessionManager).multiplexSessionWorker"),
		...
		goleak.IgnoreTopFunction("cloud.google.com/go/spanner.(*sessionManager).createMultiplexedSession"),
	)
}
